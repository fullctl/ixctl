    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('routeserver', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='routeserver', to='django_ixctl.Routeserver')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='ix',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rs_set', to='django_ixctl.InternetExchange'),
        ),
    ]
